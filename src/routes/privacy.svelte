<div class="">
	<h1>Privacy Policy for anbcodes</h1>

	<p>
		At anbcodes, accessible from anb.codes, one of our main priorities is the privacy of our
		visitors. This Privacy Policy document contains types of information that is collected and
		recorded by anbcodes and how we use it.
	</p>
	...
	<p>
		anbcodes follows a standard procedure of using log files. These files log visitors when they
	...
	<p>
		Like any other website, anbcodes uses 'cookies'. These cookies are used to store information
	...
	<p>
		For more general information on cookies, please read the "What Are Cookies" article on <a
			href="https://www.cookieconsent.com/what-are-cookies/">Cookie Consent website</a
		>.
	</p>
	...
	<p>
		...
		to serve ads to our site visitors based upon their visit to anb.codes and other sites on the
		internet. However, visitors may choose to decline the use of DART cookies by visiting the Google
		ad and content network Privacy Policy at the following URL – <a
	...
	<p>
		...
		that are used in their respective advertisements and links that appear on anbcodes, which are
	...
	<p>
		Note that anbcodes has no access to or control over these cookies that are used by third-party
		advertisers.
	</p>
	...
	<p>
		anbcodes's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
	...
	<p>
		anbcodes does not knowingly collect any Personal Identifiable Information from children under
	...
	<p>
		...
		website with regards to the information that they shared and/or collect in anbcodes. This policy
