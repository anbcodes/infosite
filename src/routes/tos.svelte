<div class="">
	...
	<p>Welcome to anbcodes!</p>

	<p>
		These terms and conditions outline the rules and regulations for the use of anbcodes's Website,
		located at anb.codes.
	</p>

	<p>
		By accessing this website we assume you accept these terms and conditions. Do not continue to
		use anbcodes if you do not agree to take all of the terms and conditions stated on this page.
	</p>
	...
	<p>
		...
		he/she or they, are taken as interchangeable and therefore as referring to same. Our Terms and
	...
	<p>
		We employ the use of cookies. By accessing anbcodes, you agreed to use cookies in agreement with
		the anbcodes's Privacy Policy.
	</p>
	...
	<p>
		Unless otherwise stated, anbcodes and/or its licensors own the intellectual property rights for
		all material on anbcodes. All intellectual property rights are reserved. You may access this
		from anbcodes for your own personal use subjected to restrictions set in these terms and
		conditions.
	</p>

	<p>You must not:</p>
	<ul>
		<li>Republish material from anbcodes</li>
		<li>Sell, rent or sub-license material from anbcodes</li>
		<li>Reproduce, duplicate or copy material from anbcodes</li>
		<li>Redistribute content from anbcodes</li>
	</ul>
	...
	<p>
		...
		information in certain areas of the website. anbcodes does not filter, edit, publish or review
		Comments prior to their presence on the website. Comments do not reflect the views and opinions
		of anbcodes, its agents and/or affiliates. Comments reflect the views and opinions of the person
		who post their views and opinions. To the extent permitted by applicable laws, anbcodes shall
	...
	<p>
		anbcodes reserves the right to monitor all Comments and to remove any Comments which can be
	...
	<p>
		You hereby grant anbcodes a non-exclusive license to use, reproduce, edit and authorize others
	...
	<p>
		...
		hyperlink compensates the absence of anbcodes; and (d) the link is in the context of general
	...
	<p>
		...
		our website, you must inform us by sending an e-mail to anbcodes. Please include your name, your
	...
	<p>
		No use of anbcodes's logo or other artwork will be allowed for linking absent a trademark
		license agreement.
	</p>
